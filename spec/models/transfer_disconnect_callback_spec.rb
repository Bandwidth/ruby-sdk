...
describe Bandwidth::TransferDisconnectCallback do
  let(:instance) { Bandwidth::TransferDisconnectCallback.new }

  describe 'test an instance of TransferDisconnectCallback' do
    it 'should create an instance of TransferDisconnectCallback' do
      expect(instance).to be_instance_of(Bandwidth::TransferDisconnectCallback)
    end
  end
