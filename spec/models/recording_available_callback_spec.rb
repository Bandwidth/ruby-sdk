...
describe Bandwidth::RecordingAvailableCallback do
  let(:instance) { Bandwidth::RecordingAvailableCallback.new }

  describe 'test an instance of RecordingAvailableCallback' do
    it 'should create an instance of RecordingAvailableCallback' do
      expect(instance).to be_instance_of(Bandwidth::RecordingAvailableCallback)
    end
  end
