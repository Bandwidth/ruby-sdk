...
describe Bandwidth::RedirectCallback do
  let(:instance) { Bandwidth::RedirectCallback.new }

  describe 'test an instance of RedirectCallback' do
    it 'should create an instance of RedirectCallback' do
      expect(instance).to be_instance_of(Bandwidth::RedirectCallback)
    end
  end
