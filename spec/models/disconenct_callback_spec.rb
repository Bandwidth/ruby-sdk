...
# Unit tests for Bandwidth::DisconenctCallback
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Bandwidth::DisconenctCallback do
  let(:instance) { Bandwidth::DisconenctCallback.new }

  describe 'test an instance of DisconenctCallback' do
    it 'should create an instance of DisconenctCallback' do
      expect(instance).to be_instance_of(Bandwidth::DisconenctCallback)
    end
  end
