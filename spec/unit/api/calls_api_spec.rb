...
#       data, status_code = @calls_api_instance.create_call_with_http_info(BW_ACCOUNT_ID, {})
...
#       expect(data.answer_method).to eq(Bandwidth::CallbackMethodEnum::POST).or eq(Bandwidth::CallbackMethodEnum::GET)
#       expect(data.answer_url).to start_with('http')
#       expect(data.answer_fallback_method).to eq(Bandwidth::CallbackMethodEnum::POST).or eq(Bandwidth::CallbackMethodEnum::GET)
#       expect(data.answer_fallback_url).to start_with('http')
#       expect(data.disconnect_method).to eq(Bandwidth::CallbackMethodEnum::POST).or eq(Bandwidth::CallbackMethodEnum::GET)
