...
describe Bandwidth::StatusCallback do
  # let(:instance) { Bandwidth::StatusCallback.new }

  describe 'test an instance of StatusCallback' do
    it 'should create an instance of StatusCallback' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Bandwidth::StatusCallback)
    end
  end
