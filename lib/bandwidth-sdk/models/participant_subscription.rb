...
module Bandwidth
  class ParticipantSubscription
    ...
    attr_accessor :stream_aliases

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'participant_id' => :'participantId',
        :'stream_aliases' => :'streamAliases'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Bandwidth::ParticipantSubscription` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Bandwidth::ParticipantSubscription`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'stream_aliases')
        if (value = attributes[:'stream_aliases']).is_a?(Array)
          self.stream_aliases = value
        end
      end
    end
    ...
    # @param [Object] stream_aliases Value to be assigned
    def stream_aliases=(stream_aliases)
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          stream_aliases == o.stream_aliases
    end
    ...
    def hash
      [participant_id, stream_aliases].hash
    end
