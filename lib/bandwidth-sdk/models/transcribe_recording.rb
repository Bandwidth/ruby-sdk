  ...
  class TranscribeRecording
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, 'The input argument (attributes) must be a hash in `Bandwidth::TranscribeRecording` initialize method'
      end
      ...
      if attributes.key?(:'detect_language')
        self.detect_language = attributes[:'detect_language']
      else
