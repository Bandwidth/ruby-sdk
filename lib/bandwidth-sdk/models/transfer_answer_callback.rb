...
module Bandwidth
  ...
  class TransferAnswerCallback
    ...
    def hash
      [event_type, event_time, account_id, application_id, from, to, direction, call_id, call_url, enqueued_time, start_time, answer_time, tag, transfer_caller_id, transfer_to].hash
    end
